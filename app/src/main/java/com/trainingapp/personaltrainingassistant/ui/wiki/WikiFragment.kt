...
class WikiFragment : Fragment()  {
    ...
    private fun loadWiki(){
        try {
            ...
            val indexClientsOverview = lines.indexOf("Clients Overview")
            val indexClientsClassification = lines.indexOf("Clients Classification")
            val indexClientsCreation = lines.indexOf("Clients Creation")
            val indexJoints = lines.indexOf("Joints")
            val indexMusclesOverview = lines.indexOf("Muscles Overview")
            val indexMusclesCreation = lines.indexOf("Muscles Deletion")
            val indexMusclesDeletion = lines.indexOf("Muscles Deletion")
            val indexExercisesOverview = lines.indexOf("Exercises Overview")
            val indexExercisesClassification = lines.indexOf("Exercises Classification")
            val indexExercisesCreation = lines.indexOf("Exercises Creation")
            val indexExercisesDeletion = lines.indexOf("Exercises Deletion")
            val indexSessionsOverview = lines.indexOf("Sessions Overview")
            val indexSessionsLimits = lines.indexOf("Sessions Limits")
