...
/**
 * Adapter to display exercise primary movers that the user can select. Only 1 primary mover can be selected. When a primary mover is clicked,
 * it's view changes to selected state and all other items are deselected
...
class AddExercisePrimaryRVAdapter(
    ...
    // Used to tell which item is selected, init as -1 to say no item is selected
