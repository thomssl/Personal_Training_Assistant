 ...
 */
class Day2 (private var sessions: ArrayList<Session2>) {
    ...
    fun getSession(index: Int): Session2 = sessions[index]
     ...
     */
    fun checkConflict(session: Session2, isSameDate: Boolean = false): Boolean{
        var result = false
